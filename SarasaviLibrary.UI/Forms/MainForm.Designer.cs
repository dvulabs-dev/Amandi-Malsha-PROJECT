namespace SarasaviLibrary.UI.Forms
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Add in reverse of visual order: Fill first, then Bottom, then Top
            ...
            // ── Exit button panel (pinned to bottom) ─────────────────────
            ...
            // Add Fill first, then Top (so topbar docks correctly)
            ...
            this.flpStats.AutoScroll    = true;
            this.flpStats.Padding       = new System.Windows.Forms.Padding(20, 22, 20, 20);
            ...
            // Add pnlMain first (Fill), then pnlSidebar (Left)
